...
# Peek behavior
PEEK_AHEAD_PX = 90
PEEK_AHEAD_TOUCH_PX = 130
PEEK_BEHIND_PX = 12
PEEK_MIN_INTERVAL_MS = 60  # cap peek rate to ~16/s
PEEK_MAX_COUNT = 200
...
IMAGE_CLICK_TOLERANCE_MOUSE_PX = int(os.getenv("IMAGE_CLICK_TOLERANCE_MOUSE_PX", "15"))
IMAGE_CLICK_TOLERANCE_TOUCH_PX = int(os.getenv("IMAGE_CLICK_TOLERANCE_TOUCH_PX", "22"))
